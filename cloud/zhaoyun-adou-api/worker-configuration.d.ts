/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/zhaoyun-adou-api/wrangler.jsonc cloud/zhaoyun-adou-api/worker-configuration.d.ts` (hash: f72e0fbe63f4f39f415bcc5f0a64df0f)
// Runtime types generated with workerd@1.20260708.1 2026-07-10 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SESSION_TTL_DAYS: "90";
	PVP_RECONNECT_SECONDS: "30";
	PVP_ROOM_TTL_HOURS: "6";
	PIN_PEPPER: string;
	TURN_SECRET: string;
	PVP_ROOM: DurableObjectNamespace<import("./src/index").PvpRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PvpRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_TTL_DAYS" | "PVP_RECONNECT_SECONDS" | "PVP_ROOM_TTL_HOURS" | "PIN_PEPPER" | "TURN_SECRET">> {}
}
